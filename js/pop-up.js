...
let list = {
    1: ['1 декабря', 'Этот кит тоже не может поверить, что осталось меньше месяца до нового года...', 'image/days2/1.png'],
    ...
    31: ['31 декабря', '', 'image/days2/31.jpg'],
    32: ['1 января', 'Всех с новым годом! Получается', 'image/days/32.jpg'],
}
